...
class mainFrame(wx.Frame):
    ...
    def onAddEvidence(self, event):
        ...
        try:
            ...
            # creating thread  
            t1 = threading.Thread(target=mainFrame.onAddEvidencePcapExtract, args=(lock, evidencePath, openFileDialog,))
            t2 = threading.Thread(target=mainFrame.onAddSessionsEvidence, args=(lock, evidencePath, openFileDialog,))
    ...
    #----------------------------#   
    def onAddEvidencePcapExtract(lock, evidencePath, openFileDialog):
        lock.acquire()
    ...
    def onAddSessionsEvidence(lock, evidencePath, openFileDialog):
        lock.acquire()     
        #global caseDbPath, evidencePath, openFileDialog
        ...
        for timestamp, buf in pcap:
            ...
            mainFrame.evidenceDetails = 1 # flag that we've got evidence
