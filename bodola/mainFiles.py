...
class mainFrame(wx.Frame):
        ...
        for ts, buf in pcap:
            ...
            if eth.type == dpkt.ethernet.ETH_TYPE_IP:
                ...
                if (src_port == 80) or (src_port == 443) or (dst_port == 80) or (dst_port == 443): 
                    ...
                    sequence = frameNumber,evidencePath,src_host_str,src_port,dst_host_str,dst_port,protocol,fileName,fileExt,fileSize,timestamp
    ...
    def onAddEvidence(self, event):
        ...
        try:
            ...
            # creating thread 
            t1 = threading.Thread(target=mainFrame.runsessions) 
            t2 = threading.Thread(target=mainFrame.rundns)
            t3 = threading.Thread(target=mainFrame.runFiles) 
