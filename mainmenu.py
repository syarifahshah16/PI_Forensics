...
class dialog(wx.Dialog):
    ...
    def onBtnHarddiskExtraction(self, event):  # wxGlade: mainMenu.<event_handler>
        #subprocess.check_call(["python", "mainHD.py"])
        print("Event handler 'onBtnHarddiskExtraction' not implemented!")
        event.Skip()
    ...
    def onBtnNetworkAnalysis(self, event):  # wxGlade: mainMenu.<event_handler>
        #subprocess.check_call(["python", "mainPCAP.py"])
        print("Event handler 'onBtnNetworkAnalysis' not implemented!")
        event.Skip()
