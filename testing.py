...
import os
import random
import SummaryTab, NewCaseDialog, AnalyzedDataTab, DeletedFilesTab, mainmenu, search, searchTab, networkanalysismenu
import connectdb
import subprocess
import sqlite3
...
"""
        ...
        docTree = self.tree_ctrl_1.AppendItem(root, "Documents")
        for x in documentsTree:
            self.tree_ctrl_1.AppendItem(docTree, x)
        exeTree = self.tree_ctrl_1.AppendItem(root, "Executables")
