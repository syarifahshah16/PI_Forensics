...
class DNSTabPanel(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.dnslist.AppendTextColumn("DNS Query", width=370)
        self.dnslist.AppendTextColumn("DNS Response", width=640)
        self.dnslist.AppendTextColumn("IP Response", width=270)
        self.dnslist.AppendTextColumn("Protocol", width=200)
        # end wxGlade
