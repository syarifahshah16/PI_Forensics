...
class FilesTabPanel(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.list_ctrl_1.AppendColumn("Reconstructed File Path", format=wx.LIST_FORMAT_LEFT, width=190)
        self.list_ctrl_1.AppendColumn("Source Host", format=wx.LIST_FORMAT_LEFT, width=250)
        self.list_ctrl_1.AppendColumn("S.Port", format=wx.LIST_FORMAT_LEFT, width=80)
        self.list_ctrl_1.AppendColumn("Destination Host", format=wx.LIST_FORMAT_LEFT, width=380)
        self.list_ctrl_1.AppendColumn("D.Port", format=wx.LIST_FORMAT_LEFT, width=80)
        self.list_ctrl_1.AppendColumn("Protocol", format=wx.LIST_FORMAT_LEFT, width=75)
        self.list_ctrl_1.AppendColumn("Filename", format=wx.LIST_FORMAT_LEFT, width=300)
        self.list_ctrl_1.AppendColumn("Extension", format=wx.LIST_FORMAT_LEFT, width=100)
        self.list_ctrl_1.AppendColumn("Size", format=wx.LIST_FORMAT_LEFT, width=75)
        # end wxGlade
